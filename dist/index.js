...
},{"inferno/dist/inferno-component":3}],2:[function(require,module,exports){
'use strict';

module.exports = require('inferno/dist/inferno-dom');
},{"inferno/dist/inferno-dom":4}],3:[function(require,module,exports){
/*!
...
(function (global, factory) {
  ...
  function updateDynamicChild(lastItem, nextItem, lastValue, nextValue, domNode, node, treeLifecycle, context, recreate) {
  ...
  function recreateRootNode(domNode, lastItem, nextItem, node, treeLifecycle, context) {
  ...
  function recreateNode(lastDomNode, lastItem, nextItem, node, treeLifecycle, context) {
  	var domNode = node.create(nextItem, treeLifecycle, context);
  ...
  function createRootNodeWithDynamicSubTreeForChildren(templateNode, subTreeForChildren, dynamicAttrs, recyclingEnabled, isSVG) {
  	...
  	var node = {
  		...
  		update: function update(lastItem, nextItem, treeLifecycle, context) {
  			...
  			nextItem.id = lastItem.id;
  			if (tree && node !== tree.dom) {
  				var newDomNode = recreateRootNode(domNode, lastItem, nextItem, node, treeLifecycle, context);
...
},{"inferno":6}],5:[function(require,module,exports){
/*!
 * inferno v0.5.21
 * (c) 2016 Dominic Gannaway
 * Released under the MPL-2.0 License.
...
},{"./dist/inferno":5}],7:[function(require,module,exports){
/**
...
var _slackList2 = _interopRequireDefault(_slackList);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var tpl1291872782 = _inferno2.default.createTemplate(function (v0) {
  return {
    tag: v0
  };
});

_infernoDom2.default.render(tpl1291872782(_slackList2.default), document.getElementById('root'));

},{"./slack-list":11,"inferno":6,"inferno-dom":2}],10:[function(require,module,exports){
'use strict';
...
var tpl148986922 = _inferno2.default.createTemplate(function (v0) {
  return {
    tag: 'span',
    attrs: {
...
},{"inferno":6,"inferno-component":1}],11:[function(require,module,exports){
'use strict';
...
var tpl109638258 = _inferno2.default.createTemplate(function () {
  return {
    tag: 'span'
  };
});
...
var SlackList = function (_Component) {
  ...
  function SlackList(props) {
    _classCallCheck(this, SlackList);
...
exports.default = SlackList;

},{"./item":10,"inferno":6,"inferno-component":1,"lodash.includes":7}]},{},[9]);
