...
var tpl4051827761 = _inferno2.default.createTemplate(function (v0, v1) {
  return {
    tag: v0,
    attrs: {
      message: v1
...
_infernoDom2.default.render(tpl4051827761(_mycomponent2.default, message), document.getElementById('root'));

},{"./mycomponent":11,"inferno":6,"inferno-dom":2}],10:[function(require,module,exports){
'use strict';
